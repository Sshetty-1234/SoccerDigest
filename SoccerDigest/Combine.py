...
def create_pdf(adp_info, goal_info, transfermarket_info) -> str:
    ...
    # Save PDF
    pdf_output = f"/Users/sohamshetty/Desktop/SoccerDigest/SoccerDigest/PL/NewsScrapers/scraper_data/Report_{current_date}.pdf"
...
if __name__ == "__main__":
    ...
    adp_info = "Example content from APN News."
    goal_info = "Latest updates from Goal.com."
    transfermarket_info = "Player transfer details from TransferMarket."
